 ...
 * 
 * Blocks are coalesced when they are freed.
 * 
 * Minimum block size of
 * 16 bytes: 8 bytes to satisfy the alignment requirement and 8 more
 * bytes for the overhead of the header and footer
 * 
 * This idea was inspired by the textbook.
 * 
 * RUN MULTIPLE TIMES BECAUSE THROUGHPUT VARIES BETWEEN 27 AND 40
 * Peak optimization is 98%
 */
#include <stdio.h>
#include <stdlib.h>
#include <assert.h>
...
team_t team = {
    ...
    "pphill10@u.rochester.edu",
    /* Second member's full name (leave blank if none) */
    "Brandon Toops",
    /* Second member's email address (leave blank if none) */
    "btoops@u.rochester.edu"
};
